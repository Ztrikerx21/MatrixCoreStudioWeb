...
$(".more_info").click(function () {
  ...
  <body>
    <main>
      <div id="cardHolder">
        <div class="card" id="card1" class="more_info">none</div>
        <div class="card" id="card2" class="more_info">none</div>
        <div class="card" id="card3" class="more_info">none</div>
        <div class="card" id="card4" class="more_info">none</div>
        <div class="card" id="card5" class="more_info">none</div>
        <div class="card" id="tempCard" class="more_info">none</div>
